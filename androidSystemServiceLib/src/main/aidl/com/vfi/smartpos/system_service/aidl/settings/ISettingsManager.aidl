...
interface ISettingsManager {
    ...
    **/
     ...
     **/
      ...
      * @param timeZoneCode represents the assigned time zone id.
      * @since 1.11.3
      **/
    ...
    */
    ...
    /**
     *  just for Korean ROM, set Wifi state, WIFI state is false by default.
     * if set state is true when WIFI state is opening, then need to reboot device to let this setting take effect.
     * @param state
     ...
     * @throws RemoteException
     */
    boolean getsetWifiSettingState();
